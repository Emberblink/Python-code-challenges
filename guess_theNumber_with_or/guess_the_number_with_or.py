...
if (user_guess_int == correct_number):
    print("Congratulations! That's correct!")
      ...
      or
      user_guess_int - 1 == correct_number):
    print(f"But you were very close! The correct number was {correct_number}.")
else:
    print(f"Sorry, that's incorrect. The correct number was {correct_number}.")
